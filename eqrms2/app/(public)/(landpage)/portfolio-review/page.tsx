...
export default function RMSPage() {
    return (
        ...
        <AlertBox color="red" heading="Is your portfolio really working for you?">
            <ul>
                <li>Is it aligned to your risk-profile, goals & liqudity requirements?</li>
                ...
                <li>Are there funds that are pulling down your returns OR not the right funds for your needs?</li>
            </ul>

            <p>For many investors, these questions are difficult to answer with confidence. That is exactly where a deeper, more personalised portfolio review can add significant value.</p>
        </AlertBox>
        ...
        <Section className="bg-gray-100 py-12">
            ...
            <p>Most portfolio reviews are either too generic, too performance-led, or too influenced by what the reviewer wants you to do next. IME Capital offers a stronger alternative — combining the credibility of the <b>IME RMS </b>(our proprietary research platform), with a <b>deeply personalised review</b> built around your goals, risk profile, and financial needs.</p>
            <div className="ime-grid-2col">
                <AlertBox color="blue" heading="Driven by The IME RMS">
                <p>Access deeper institutional-grade fund research, detailed rating rationales, and a single point of truth that reduces the scope for biased or self-serving reviews.</p>
                </AlertBox>
                <AlertBox color="green" heading="Personalised to You">
                <p>A meaningful review should assess not just whether a fund is good or bad, but whether it is right for your portfolio, your goals, and your risk appetite.</p>
                </AlertBox>
            </div>
            <p><b>IME's Comprehensive Portfolio review </b>inludes a complimentary <b>15-day IME RMS trial</b>, receive <b> 3 detailed one-on-one consultations </b>with a Senior Private Banker. </p>
       ...
       <div className="flex flex-col md:flex-row max-w-7xl mx-auto gap-12 py-12">
        <div className="w-full md:w-[400px] md:min-w-[200px] md:flex-shrink-0 text-center my-auto"> 
            ...
            <p>All portfolio reviews are driven by the IME RMS - which gives investors direct access to IME's ratings & detailed rating rationales across all funds. This single point-of-truth add tremendous credibility & transparency to reviews, making selective or agenda-based reviews impossible. </p>

<p>Our rating methodology is driven by a combination of quantiative & qualitative factors, resulting in much more robust & valuable insights as compared to reviews driven primarily by past performance (which may or may not be repeated in the future).</p>
        ...
        <Section className="py-12 bg-gray-100">
            ...
            >
                <p>A portfolio review has limited value unless it assesses whether your investments are truly right for you. That means evaluating not just individual funds, but whether your portfolio construction is sound — whether the risks are appropriate, liquidity needs are being respected, the right categories have been considered, and whether relevant options may have been overlooked.</p>

<p>Through a one-on-one consultation with a Senior Private Banker, we work to understand your goals, risk profile, and broader requirements in depth, and help define your IME Investment Mandate — a written strategic blueprint that ensures your portfolio is assessed against a clear long-term framework tailored to you.</p>
            </ImageTextBox>
            </Section>
            ...
            <Section>
                ...
                <ul>
                    <li>how well your portfolio aligns with your goals and requirements</li>
                    <li>whether your portfolio construction is truly robust</li>
