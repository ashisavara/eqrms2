    ...
    return (
        <div className="max-w-4xl mx-auto ime-blog-pag px-6 md:px-0 pt-5">
            ...
            <div className="flex flex-row justify-center gap-2">
                ...
                <Badge variant="secondary">{blog.category} </Badge>  <span className="text-sm text-gray-500">| Written by IME's Investor Desk on {formatDate(blog.created_at)} and last modified on  {formatDate(blog.last_modified)} </span>
            </div>
