      ...
      <div className="space-y-4">
        ...
        <Tabs defaultValue="investments" className="w-full">
          ...
          {can(userRoles, 'investments', 'add_edit_held_away') && (
            ...
            />
            <p className="helper-text"><span className="font-bold">Note:</span> All values in Rs. lakhs | Abs Ret & CAGR (absolute returns & annualised returns) are in % |<span className="font-bold"> Last Updates:</span> Daily (MF, IME PMS, Kristal), Monthly (PMS: 30-Sep, AIF: 31-Aug), Held-Away (when last given by investor). 
