...
export const columnsPmsBlog: ColumnDef<blogDetail>[] = [
  {
    accessorKey: "title",
    header: "Title",
    size: 300,
    cell: ({ row }) => {
      ...
      return title ? (
        <div className="text-left">
          <Link href={`/internal/public-site/pmsblog/${blogId}`} className="blue-hyperlink">
            {title}
          </Link>
        </div>
      ) : null;
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link
          href={`/internal/public-site/pmsblog/edit/${blogId}`}
