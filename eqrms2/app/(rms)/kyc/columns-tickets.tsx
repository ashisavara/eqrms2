...
import { ImportanceRating, StatusRating } from "@/components/conditional-formatting";
...
export const columns: ColumnDef<Ticket>[] = [
  ...
  { accessorKey: "status", header: "Status",  size:80,
    cell: ({ getValue }) => getValue() == null ? null : <StatusRating rating={getValue() as string}>{getValue() as string}</StatusRating>, filterFn: "arrIncludesSome" },
