...
export async function POST(req: NextRequest) {
  try {
    ...
    const results = await supabaseListRead<LoginProfileWithRoles>({
      ...
      columns: 'uuid, phone_number, lead_name, user_role_name, user_role_name_id, expires_on, lead_id, crm_lead_name, group_id, group_name, rm_name, mandate_id, mandate_name',
      filters
    });
