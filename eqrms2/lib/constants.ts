...
export const MASTER_OPTIONS = {
  ...
  fundPerformanceAsOf: [
    "Performance as of: 31-Aug-25 (returns >1yr are annualised returns). Returns are pre-tax returns, post all fees & expenses. Global fund returns are in USD or in the funds currency"
  ],
